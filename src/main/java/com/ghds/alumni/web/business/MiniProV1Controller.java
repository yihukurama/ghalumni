...
//    }
    ...
    @ApiOperation(httpMethod = "POST", value = "查询校友列表", notes = "查询校友列表")
    @RequestMapping(value = "/listEmpInfos", method = RequestMethod.POST)
    public Result listEmpInfos(@RequestBody Request<Wxuser> request) throws TipsException, NoSuchMethodException {
